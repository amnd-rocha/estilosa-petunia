...
function refresh() {
  switch (true) {
    ...
    case page == 2: {
      ...
      if (outfitNum == 2) {
        levelDescription.innerHTML = 'Agora Petúnia vai para uma feira medieval.<br/>Faça a sua mágica e encontre essa fantasia!';
      }
      if (outfitNum == 3) {
        levelDescription.innerHTML = 'Para encerrar o dia, nada melhor que um show de rock,<br/>mas cuidado para não perder a banda!';
      }
      break;
    }
    case page == 3: {
    ...
    case page == 4: {
      ...
      if (outfitNum == 1) {
        ...
        finalMsg.innerHTML = "Uau! Graças à sua ajuda, Petúnia tirou 10!";
      }
      if (outfitNum == 2) {
        ending.style.backgroundImage = "url('img/image3.png')";
        finalMsg.innerHTML = "Parabéns! Você fez da Petúnia <br/>a elfa mais linda do reino.";
      }
      if (outfitNum == 3) {
        ending.style.backgroundImage = "url('img/image4.png')";
        finalMsg.innerHTML = 'Isso aí! Petúnia estava tão estilosa<br/> que chamou mais atenção que o show!';
